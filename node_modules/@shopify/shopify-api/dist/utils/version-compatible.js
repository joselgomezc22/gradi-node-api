...
function versionCompatible(referenceVersion, currentVersion) {
    ...
    if (currentVersion === base_types_1.ApiVersion.Unstable || currentVersion === base_types_1.ApiVersion.Unversioned) {
        return true;
    }
    var numericVersion = function (version) { return parseInt(version.replace('-', ''), 10); };
